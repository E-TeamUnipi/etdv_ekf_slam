INTRODUCTION:
## E-Team Squadra Corse: EKF-SLAM Node Documentation (2025/26)
...
1. [Node Interface](1-node-interface.md)
2. [EKF Core Logic & Architecture](2-ekf-core-logic-architecture.md)
3. [Latency Reduction & Optimization](3-latency-reduction-and-optimization)
4. [Current Test Results](4-current-test-results.md)
